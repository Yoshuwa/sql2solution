...
- `src/AdventureWorksLT2017Api.Api/Controllers/Custom`: workflow-specific controllers and endpoints.
- `src/AdventureWorksLT2017Api.Application/Features`: commands, queries, validators, orchestration services, and use cases.
- `src/AdventureWorksLT2017Api.Domain/Services`: domain rules that span multiple entities.
- `src/AdventureWorksLT2017Api.Infrastructure/Integrations`: external APIs, messaging, storage, background jobs, and adapters.
- `src/AdventureWorksLT2017Api.Api/CompositionRoot/CustomServiceRegistration.cs`: dependency injection for custom services.
...
- Put bespoke Razor Pages in `src/AdventureWorksLT2017Api.Client/Pages/Custom`.
- Put hand-written UI API clients and adapters in `src/AdventureWorksLT2017Api.Client/Services/Custom`.
...
- Put bespoke Blazor pages and components in `src/AdventureWorksLT2017Api.Blazor/Components/Pages/Custom`.
- Put hand-written Blazor API clients and adapters in `src/AdventureWorksLT2017Api.Blazor/Services/Custom`.
