...
public sealed class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    ...
    private static string ResolveConnectionString()
    {
        ...
        return "Data Source=.;Initial Catalog=AdventureWorksLT2017;Integrated Security=True;Connect Timeout=5;Encrypt=False;Trust Server Certificate=True";
    }
}